        ...
        <Container>
          <Row className="align-items-center">
            <Col lg={6} className="text-center text-lg-start mb-5 mb-lg-0">
              ...
              <h2>save up to 20%</h2>
              <p>
              Get the best of our delicious burgers right at your fingertips! Download our mobile app today and enjoy an exclusive 20% off your first order. Ordering has never been easier – and neither has saving!
              </p>
              <Link to="/">
                <img
                  src={StoreIOS}
